...
const BiyteLumHomepage = () => {
  ...
  return (
    <div className="min-h-screen overflow-hidden relative" style={{ 
      ...
      {/* Main Content Sections - Original Content */}
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    {/* Add Get Started button for the third section */}
                    {feature.hasButton && (
                      <div className="mt-6">
      ...
      <style jsx>{`
        ...
        @keyframes pulse-glow {
          0%, 100% { box-shadow: 0 0 5px #A7FF9E; }
          50% { box-shadow: 0 0 20px #A7FF9E, 0 0 30px #00FF99; }
        }
      `}</style>
    </div>
  );
